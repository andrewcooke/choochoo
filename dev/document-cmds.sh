...
COMMANDS='activities constants data default-config diary fit fix-fit garmin help jupyter monitor statistics no-op package-fit-profile test-schedule unlock'
