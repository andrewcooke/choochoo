...
class WebServer:
    ...
    def __init__(self, db, jcontrol):
        ...
        self.url_map = Map([
            ...
            Rule('/api/kit/retire', endpoint=kit.write_retire, methods=('PUT', )),
            Rule('/api/kit/components', endpoint=kit.read_statistics, methods=('GET', )),
            Rule('/api/kit/<date>', endpoint=kit.read_statistics, methods=('GET', )),
