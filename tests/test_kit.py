    ...
    def test_bikes(self):
        with NamedTemporaryFile() as f:
            ...
            with db.session_context() as s:
                ...
                change(s, 'cotic', 'chain', 'sram', '2018-02-01', True)
                change(s, 'cotic', 'chain', 'kcm', '2018-01-01', False)
                change(s, 'cotic', 'chain', 'sram', '2018-05-01', False)
                change(s, 'cotic', 'chain', 'kcm', '2018-07-01', False)
                change(s, 'cotic', 'chain', 'sram', '2018-04-01', False)
                with self.assertRaises(Exception) as ctx:
                ...
                change(s, 'bowman', 'chain', 'sram', None, False)
