...
To check for errors in `myfile.fit`:
    ...
    > ch2 fix-fit myfile.fit --discard
        INFO: Version 0.32.0
        INFO: Using database at /home/andrew/.ch2/0-32/data/activity.db
        INFO: Using database at /home/andrew/.ch2/0-32/data/system.db
        INFO: Database version 0-32
        INFO: Input ----------
        INFO: Reading binary data from myfile.fit
    CRITICAL: [Errno 2] No such file or directory: 'myfile.fit'
     WARNING: Traceback:
      File "/home/andrew/project/ch2/choochoo-1/py/ch2/__init__.py", line 113, in main
        command(args, sys, db)
      File "/home/andrew/project/ch2/choochoo-1/py/ch2/commands/fix_fit.py", line 62, in fix_fit
        data = read_fit(path)
      File "/home/andrew/project/ch2/choochoo-1/py/ch2/fit/profile/profile.py", line 57, in read_fit
...
can see what records that affected as follows:
    ...
    CRITICAL: [Errno 2] No such file or directory: 'myfile.fit'
     WARNING: Traceback:
      File "/home/andrew/project/ch2/choochoo-1/py/ch2/__init__.py", line 113, in main
        command(args, sys, db)
      File "/home/andrew/project/ch2/choochoo-1/py/ch2/commands/fit.py", line 69, in fit
