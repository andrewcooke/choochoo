...
rm -f /tmp/copy.sqlo
cp ~/.ch2/database.sqlo ~/.ch2/database.sqlo-backup
mv ~/.ch2/database.sqlo /tmp/copy.sqlo
...
rm -f ~/.ch2/database.sqlo
dev/ch2 no-op

sqlite3 ~/.ch2/database.sqlo < /tmp/dump-o.sql
