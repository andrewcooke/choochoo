...
def parser():
    ...
    parser.add_argument(m(F), mm(DATABASE), action='store', default='${root}/database.sqlm', metavar='FILE',
    ...
    parser.add_argument(m(V.upper()), mm(VERSION), action='version', version='0.6.11',
